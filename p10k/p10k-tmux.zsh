# Generated by Powerlevel10k configuration with LEELSEY.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode, 24h time, angled separators, sharp heads, flat tails, 1 line, sparse, few icons, concise, transient_prompt, instant_prompt=verbose.
