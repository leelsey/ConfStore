...
# Wizard options: nerdfont-complete + powerline, small icons, classic, unicode, dark, vertical separators, round heads, round tails, 1 line, sparse, many icons, concise, transient_prompt, instant_prompt=verbose.
